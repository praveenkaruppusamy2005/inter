    ...
    <main className="legal-main">
      <div className="marketing-container">
        ...
        <p className="legal-p" style={{ textAlign: 'center', maxWidth: 720, margin: '0 auto 28px' }}>
          Professional interview assistance at an affordable rate of just Rs 100 per hour.
        </p>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 18 }}>
          ...
          <div className="card" style={{ border: '2px solid black',borderBottom:'5px solid black' }}>
            ...
            <div style={{ fontSize: 42, fontWeight: 900, margin: '12px 0' }}>Rs 100<span style={{ fontSize: 18, fontWeight: 500, color: '#666' }}>/hour</span></div>
            ...
            <div style={{ display: 'flex', gap: 10 }}>
              <p>Available for just Rs 100 in the App</p>
            </div>
          </div>
          <div />
        </div>
